...
public class ReportService {
    ...
    public ReportService(ReportRepository reportRepository, UserService userService, CommentRepository commentRepository, UrlInfoRepository urlInfoRepository) {
    ...
    private void handleUrlReport(Long urlInfoId, boolean isAdmin) {
        ...
        if (isAdmin) {
            urlInfo.setTitle("비정상 웹페이지 입니다.");
            urlInfo.setFaviconSrc(null);
            urlInfo.setDescription("접근 주의");
        }
